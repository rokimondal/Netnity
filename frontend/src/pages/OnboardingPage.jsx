      ...
      <div className='card bg-base-100 w-full max-w-3xl'>
        <div className='card-body p-6 sm:p-8'>
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <button type='submit' className='btn w-full btn-primary' disabled={isPending}>{isPending ? <span className="loading loading-dots loading-xl"></span> : "Complete Onboarding"
            }
            </button>
          </form>
        </div>
